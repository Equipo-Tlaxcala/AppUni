      ...
      children: [
        TableRow(children: [
          ...
          _SigleCard(
              ...
              image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaMOvuwsfNZweOm_YX1o-Ia_QyRUqwJpVTDw&s',
              text: 'Ingenieria en Biomedica'),
        ]),
        TableRow(children: [
          _SigleCard(
            color: Colors.purple,
...
class _SigleCard extends StatelessWidget {
  ...
  String _getCareerDescription(String careerName) {
    Map<String, String> descriptions = {
      'Ingenieria En Software': 'En la carrera de Ingeniería en Software, el profesionista estará facultado para diseñar, desarrollar y mejorar la calidad de productos de software; especificar los métodos y las herramientas para aumentar la productividad de los desarrolladores de software; controlar los procesos de manera eficiente; aplicar los estándares internacionales para construir software de alta calidad.\n\n'
      ...
      'Ingenieria en Biomedica':
          'La Ingeniería Biomédica combina principios de ingeniería con ciencias médicas para desarrollar tecnologías y dispositivos que mejoren la atención médica y la calidad de vida de los pacientes.',
      'Ingenieria Finaciera':
          'La Ingeniería Financiera aplica herramientas matemáticas y computacionales para resolver problemas financieros complejos, incluyendo gestión de riesgos, inversiones y optimización de portafolios.',
      'Licenciatura en Administracion y Gestion Empresarial':
          'Esta carrera forma profesionales capaces de gestionar organizaciones, optimizar recursos y desarrollar estrategias empresariales efectivas para el crecimiento y sostenibilidad de las empresas.',
      'Ingenieria en Biotecnologia':
          'La Ingeniería en Biotecnología utiliza sistemas biológicos y organismos vivos para desarrollar productos y procesos innovadores en áreas como medicina, agricultura y medio ambiente.',
      'Licenciatura en Terapia Fisica':
          'La Terapia Física se especializa en la rehabilitación y tratamiento de lesiones y condiciones que afectan el movimiento humano, promoviendo la recuperación y el bienestar físico de los pacientes.',
    };
